...
const mongoose_user_repository_1 = require("./infrastructure/database/mongoose-user.repository");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: user_schema_1.UserDocumentClass.name, schema: user_schema_1.UserSchema },
            ]),
        ],
        providers: [
            {
        ...
        exports: [user_repository_interface_1.IUserRepository, mongoose_1.MongooseModule],
    })
], UsersModule);
